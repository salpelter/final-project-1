...
public class BranchesAndAtmsPage {
    ...
    public SelenideElement highlightedMarkerInformationBlock =
            $x("//app-atm-branches-section-list-item/div[contains(@class, 'active')]");
    public SelenideElement map =
            $x("//google-map/div[@class='map-container']/div");
    public SelenideElement cityDropdown =
            $("tbcx-dropdown-selector i");
    public ElementsCollection cities =
            $$x("//tbcx-dropdown-popover-item");
    public SelenideElement branchesFilter =
            $x("//span[text()='ფილიალები']");
    public SelenideElement openFilter =
            $x("//span[text()=' ღიაა ']");
}
