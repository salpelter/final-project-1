...
public class MoneyTransfersPage {
    public SelenideElement moneyTransferFeesTab =
            $x("//span[text()='გზავნილის გაგზავნის საკომისიო']");
    public SelenideElement currencyDropdown =
            $x("//input[@id='tbcx-text-input-1']//parent::div//following-sibling::div//i");
    ...
    public ElementsCollection transferFeeResults =
            $$x("//tbcx-pw-money-transfer-fee-calculator//tbcx-pw-money-transfer-system-card");
}
